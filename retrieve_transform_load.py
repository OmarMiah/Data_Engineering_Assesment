...
if __name__ == "__main__":
    ...
    df.rename(
        columns={"ip": "masked_ip", "device_id": "masked_device_id"}, inplace=True
    )
    ...
    sql_altertable = (
        """ALTER TABLE user_logins ALTER COLUMN app_version TYPE varchar (255);"""
    )
    cursor.execute(sql_altertable)

    sql_altertable2 = (
        """ALTER TABLE user_logins ALTER COLUMN locale TYPE varchar (255);"""
    )
    cursor.execute(sql_altertable2)

    sql_altertable3 = (
        """ALTER TABLE user_logins ALTER COLUMN device_type TYPE varchar (255);"""
    )
